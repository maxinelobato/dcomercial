          ...
          >
            <Flex flex={1}>
              <Image
                objectFit="cover"
                boxSize="50%"
                src={"/src/assets/fragrancias.png"}
              />
              <Stack
                flex={1}
                flexDirection="column"
          ...
          >
            <Flex flex={1}>
              <Image
                objectFit="cover"
                boxSize="50%"
                src={"/src/assets/melhorpreco.jpg"}
              />
              <Stack
                flex={1}
                flexDirection="column"
